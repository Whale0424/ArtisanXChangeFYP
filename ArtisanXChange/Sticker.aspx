<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Sticker.aspx.cs" Inherits="ArtisanXChange.Sticker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="product-container">
        <img src="Image/ImageSticker.jpg" alt="Stickers"/>
        <h1>Stickers</h1>
    </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT LocalProdID, LocalProdName, LocalProdDesc, LocalProdPrice, LocalProdImageURL 
                       FROM LocalProducts WHERE LocalCatID = 1002">
    </asp:SqlDataSource>
</asp:Content>