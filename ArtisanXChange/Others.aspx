<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Others.aspx.cs" Inherits="ArtisanXChange.Others" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Others - ArtisanXChange</title>
        <style>
        html, body {
            margin: 0;
            padding: 0;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="product-container">
        <img src="Image/ImageOthers.jpg" alt="Others"/>
        <h1>Others</h1>
    </div>
                ...
                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT LocalProdID, LocalProdName, LocalProdDesc, LocalProdPrice, LocalProdImageURL 
                                       FROM LocalProducts WHERE LocalCatID = 1004">
                    </asp:SqlDataSource>
                </asp:Content>