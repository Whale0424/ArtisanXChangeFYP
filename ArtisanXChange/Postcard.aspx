<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Postcard.aspx.cs" Inherits="ArtisanXChange.Postcard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Postcards - ArtisanXChange</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="product-container">
        <img src="Image/ImagePostcard.jpg" alt="Postcards">
        <h1>Postcards</h1>
    </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT LocalProdID, LocalProdName, LocalProdDesc, LocalProdPrice, LocalProdImageURL 
                       FROM LocalProducts WHERE LocalCatID = 1003">
    </asp:SqlDataSource>
</asp:Content>